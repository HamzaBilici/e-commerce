  ...
  return (
    <>
      <section className="w-full flex justify-center py-20 min-h-164.5 ">
        <div className="max-w-281 flex items-center   max-h-124.5 h-full w-full justify-between max-lg:flex-col-reverse max-lg:px-5 max-lg:gap-12.5 max-lg:min-h-190">
          <div className="flex flex-row  w-full h-124.5 max-w-lg gap-4 min-w-93.5 max-lg:min-h-91 ">
          ...
          <div className="max-w-111.75 flex flex-col gap-4 min-w-70 max-lg:mx-20">
